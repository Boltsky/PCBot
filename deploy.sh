...
# Deployment script for PCRst Bot
...
# Launch application
printf "\n\033[1;34mStarting PCRst bot...\033[0m\n"
python3 PCRst.py &

# Monitor logs (display last 100 lines)
printf "\n\033[1;34mTailing logs...\033[0m\n"
tail -f -n 100 /var/log/pcrst/pcrst.log 

# This script assumes the bot logs to /var/log/pcrst/pcrst.log. Adjust as necessary.
